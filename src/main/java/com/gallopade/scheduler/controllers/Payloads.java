            ...
            try {
                ...
                if (questionNum >= 1 && questionNum <= 21) {
                    ...
                    if (mapping != null && mapping.getQuestion() != null) {
                        ...
                        // Update studentClassAssignmentId in the payload with the value from CSV
                        ...
                        if (studentClassAssignmentAnswer != null) {
                            // Replace the hardcoded studentClassAssignmentId from JSON with the actual one from CSV
